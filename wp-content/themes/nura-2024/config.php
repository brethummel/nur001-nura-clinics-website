...
$GLOBALS['produrl'] = 'spinecaremw.com';
...
function spr_add_theme_fonts($themeurl) {
    wp_enqueue_style('google-fonts', 'https://fonts.googleapis.com/css2?family=Nunito+Sans:ital,opsz,wght@0,6..12,200..1000;1,6..12,200..1000&display=swap');
    wp_enqueue_style('adobe-fonts', 'https://use.typekit.net/gyk4ngd.css');
...
add_action('acf/init', function() {
	...
	require($themedir . $sprpath . '/private/functions/ui_customize_blocks.php');
// 	require($themedir . $sprpath . '/private/functions/ui_shortcodes.php');
});
