...
<?php $block = $args; 
	...
	$cats = false;
	// echo('<pre style="margin-top: 100px !important;">'); print_r($return['categories']); echo('</pre>');
	...
	if (isset($catslug)) {
		...
		$args['cat'] = $catlist;
		// echo('<pre>'); print_r('cats pulled from query string!'); echo('</pre>');
	} elseif ($cats) {
		$catlist = implode(', ', $cats);
		$args['cat'] = $catlist;
		// echo('<pre>'); print_r('cats pulled from $cats!'); echo('</pre>');
	} 
