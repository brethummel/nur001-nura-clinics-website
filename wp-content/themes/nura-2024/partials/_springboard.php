...
// load required functions (necessary for SpringBoard to run)
...
function spr_load_admin_style() {
    ...
    wp_enqueue_style('theme-admin', get_template_directory_uri() . '/admin.css', array(), filemtime(get_template_directory() . '/admin.css'));
