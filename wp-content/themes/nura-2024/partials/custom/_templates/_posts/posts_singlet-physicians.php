<?php
/*
Template Name: Physician Posts
Partial Name: singlet_post-physicians
*/
?>
<?php $result = $args; 
...
<div class="post-container<?php echo($classes); ?><?php if ($filters) { echo(' ' . $mycat); }?><?php if ($pagenum > 1) { ?> just-loaded<?php } ?>"<?php if ($filters) { ?> data-cats="<?php echo($cats); ?>" <?php } ?> data-page="<?php echo($pagenum); ?>">
	<div class="post col-12">
		...
		<div class="text-container">
			...
			<?php } ?>
			<?php if (isset($attribution['name']) && $attribution['name'] != '') { ?><p class="attribution">by <?php echo($attribution['name']); ?><?php if (isset($attribution['title']) && $attribution['title'] != '') { ?>, <?php echo($attribution['title']); ?><?php } ?><?php if (isset($attribution['org']) && $attribution['org'] != '') { ?> <?php echo($attribution['org']); ?><?php } ?></p><?php } ?>
