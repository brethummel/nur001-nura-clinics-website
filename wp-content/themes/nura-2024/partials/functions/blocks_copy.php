...
function spr_copy_blocks_button($field) {
	$button = '</a><a class="spr-button button button-secondary" href="#" data-name="copy-layouts">Copy Blocks';
...
function spr_copy_blocks_post_selector() {
	...
	if ($addcopyblocks) {
		...
		$selectorHTML .= '<a class="spr-button button button-secondary" href="#" data-name="posts-cancel">Cancel</a>';
		$selectorHTML .= '<a class="spr-button button button-primary disabled" href="#" data-name="posts-next">Set Source</a>';
		...
		$themedir = get_template_directory();
		$sprpath = $GLOBALS['springboard_path'];
		$selectorHTML .= '<div class="spr-field blocks-list" data-name="content_blocks" data-themeurl="' . $themeurl . '" data-sprpath="' . $sprpath . '">';
		...
		$selectorHTML .= '<a class="spr-button button button-secondary" href="#" data-name="blocks-cancel">Cancel</a>';
		// $selectorHTML .= '<input type="submit" name="save" id="publish" class="button button-primary disabled" value="Copy Blocks">';
		$selectorHTML .= '<a class="spr-button button button-primary disabled" href="#" data-name="blocks-copy">Copy Blocks</a>';
