...
### 2.0.2 - 2025-08-21
- added logging when `wp_schedule_single_event` is called
...
### 1.0.2 - 2026-01-29
- disabled `page_link/query` filter
...
### 1.0.2 - 2026-02-27
- added `$multilocs` variable in function that creates contact info's acf field set
...
### 1.0.2 - 2025-08-17
- added `$leadattribution` variable in function that creates attribution's acf field set
...
### 1.0.2 - 2025-11-04
- corrected path to admin.js
- adjusted how the `add button` MCE plugin loaded it's javascript
