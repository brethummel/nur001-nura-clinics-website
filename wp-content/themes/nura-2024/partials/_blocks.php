	...
	if (have_rows('content_blocks', $id)):
		while (have_rows('content_blocks', $id)) : the_row();
			...
			if ($displayblock) {
				...
				elseif ($layout == 'block_patientstory'):
