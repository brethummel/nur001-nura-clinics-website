jQuery(document).ready(function($) { 
	...
	$('.acf-field-610ac7050d4ff .acf-input .acf-flexible-content .acf-actions a.spr-button[data-name="copy-layouts"]').on('click', function(event) {
	...
	$('#poststuff #post-body #post-body-content .spr-select-source .select-container .select-post .posts-actions a.spr-button[data-name="posts-cancel"], #poststuff #post-body #post-body-content .spr-select-source .select-container .select-blocks .blocks-actions a.spr-button[data-name="blocks-cancel"], #poststuff #post-body #post-body-content .spr-select-source .select-container.post .select-post .posts-list .unsaved-changes input#publish').on('click', function(event) {
		...
		$('#poststuff #post-body #post-body-content .spr-select-source .select-container').delay(300).queue(function() {
			...
			$('#poststuff #post-body #post-body-content .spr-select-source .select-container.post .select-post .posts-actions a.spr-button[data-name="posts-next"]').addClass('disabled'); // disable button
	...
	$('#poststuff #post-body #post-body-content .spr-select-source .select-container .select-post .posts-actions a.spr-button[data-name="posts-next"]').on('click', function(event) {
	...
	$('#poststuff #post-body #post-body-content .spr-select-source .select-container .select-blocks .blocks-list').on('click', '.blocks-container .spr-layout', function(event) {
		if (!$(this).hasClass('selected')) {
	...
	$('#poststuff #post-body #post-body-content .spr-select-source .select-container .select-blocks .blocks-list').on('click', '.blocks-container h3 span.select-controls span', function(event) {
		if ($(this).hasClass('all')) {
			blockcount = 0;
			$('#poststuff #post-body #post-body-content .spr-select-source .select-container .select-blocks .blocks-list .blocks-container .spr-layout').each(function(index) {
				$(this).addClass('selected').find('input[type="checkbox"]').prop('checked', true);
				blockcount++;
			});
		} else {
